...
class DPOTrainer(Trainer):
    ...
    # def get_batch_samples(self, epoch_iterator, num_batches: int, device: str):
    #     """Generate samples from the model and reference model for the given batch of inputs."""
    #     # This method is called by the parent Trainer but we don't need it for DPO training
    #     # Return empty lists to satisfy the interface
    #     return [], 0
